...
export const metadata = {
  ...
  description: 'Перелік заборонених товарів та правила публікації лотів на українській beta-платформі KRAM',
}
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-[#64748B] text-[14.5px] leading-relaxed">
                KRAM є українською інформаційною beta-платформою, яка прагне підтримувати культуру чесних і безпечних прямих домовленостей. Ми суворо дотримуємося законодавства України та вимагаємо цього від кожного нашого користувача. Будь-які порушення караються негайним блокуванням акаунта.
              </p>
            </div>
          </div>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-6 shadow-sm">
            <p className="text-[#64748B] text-[14px] mb-6">
              Наступні категорії товарів категорично заборонено розміщувати на платформі. Усі подібні лоти видаляються модератором миттєво:
            </p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-[#EFF6FF] border border-[#BFDBFE] rounded-2xl p-6 text-[14px] text-[#1E40AF] leading-relaxed">
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>Повне та безповоротне блокування облікового запису за серйозні порушення чи повторний обман.</li>
            </ul>
            <p className="mt-4">
