...
export default function SellersPage() {
  ...
  const [submitted, setSubmitted] = useState(false)'use client'
...
const launchCategories = ['Дитячі товари', 'Одяг та взуття', 'Телефони', 'Ноутбуки', 'Ігрові консолі', 'Комплектуючі ПК', 'Інструменти', 'Техніка для дому']
        ...
        <div className="relative max-w-[1320px] mx-auto px-4 py-16 lg:py-24 grid lg:grid-cols-[1.05fr_0.95fr] gap-12 items-center">
          <div>
            ...
            <p className="text-[16px] text-[#475569] leading-relaxed max-w-[620px] mb-8">
              KRAM зараз збирає перших продавців з реальними лотами: дитячі товари, одяг і взуття, смартфони, ноутбуки, консолі, комплектуючі, інструменти та техніка для дому. Ми не приймаємо оплату і не утримуємо кошти — платформа фіксує лот, ставки, переписку та статус домовленості.
            </p>
            ...
            <div className="grid sm:grid-cols-3 gap-3 max-w-2xl">
              ...
              <div className="p-4 bg-white border border-[#E2E8F0] rounded-2xl">
                ...
                <p className="text-[12px] text-[#64748B] mt-1">Без комісії за публікацію та ставки на старті.</p>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-[1320px] mx-auto px-4 py-16 grid lg:grid-cols-[0.9fr_1.1fr] gap-10">
        <div>
          ...
          <p className="text-[14px] text-[#64748B] leading-relaxed mb-6">
            На старті KRAM краще мати 20–50 реальних сильних лотів, ніж 200 випадкових оголошень. Тому ми фокусуємось на категоріях, де покупцям важливі фото, чесний опис стану, прозора ціна та швидка домовленість напряму.
          </p>
