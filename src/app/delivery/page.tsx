...
const steps = [
  ...
  },
  {
    ...
    text: 'У beta/MVP режимі підтвердження може бути ручним. Після LiqPay production статус оновлюватиметься за callback.',
  },
  {
    icon: Truck,
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <aside className="rounded-[1.75rem] border border-[#BAE6FD] bg-[#F0F9FF] p-7">
            ...
            <p className="mt-3 text-[14px] leading-relaxed text-[#0369A1]">
              До повного production-підключення LiqPay і автоматичних інтеграцій частина підтверджень може виконуватись вручну. Ми не радимо оплачувати поза платформою або переходити за сторонніми посиланнями від продавця.
            </p>
          </aside>
        </div>
      </section>
