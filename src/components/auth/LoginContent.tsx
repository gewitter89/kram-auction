          ...
          <div className="space-y-2.5 mb-6">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                onClick={() => {
                  setError('')
                  setInfoAlert('Вхід через Facebook буде доступний у версії v1.0. Будь ласка, використовуйте Google або Email.')
                }}
                className="h-11 flex items-center justify-center gap-2 bg-white border border-[#E2E8F0] rounded-xl text-[13px] font-medium text-[#0F172A] hover:bg-[#F8FAFC] hover:border-[#CBD5E1] transition-colors cursor-pointer"
              >
              ...
              <button
                ...
                onClick={() => {
                  setError('')
                  setInfoAlert('Вхід через GitHub буде доступний у версії v1.0. Будь ласка, використовуйте Google або Email.')
                }}
                className="h-11 flex items-center justify-center gap-2 bg-white border border-[#E2E8F0] rounded-xl text-[13px] font-medium text-[#0F172A] hover:bg-[#F8FAFC] hover:border-[#CBD5E1] transition-colors cursor-pointer"
              >
