        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/payments" className="text-[13px] text-[#64748B] hover:text-[#2563EB]">Як купувати</Link></li>
              <li><Link href="/safety" className="text-[13px] text-[#64748B] hover:text-[#2563EB]">Безпечна угода</Link></li>
              <li><Link href="/delivery" className="text-[13px] text-[#64748B] hover:text-[#2563EB]">Доставка</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/delivery" className="text-[13px] text-[#64748B] hover:text-[#2563EB]">Як продавати</Link></li>
              <li><Link href="/payments" className="text-[13px] text-[#64748B] hover:text-[#2563EB]">Тарифи</Link></li>
              <li><Link href="/safety" className="text-[13px] text-[#64748B] hover:text-[#2563EB]">Верифікація</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/support" className="text-[13px] text-[#64748B] hover:text-[#2563EB]">Контакти</Link></li>
              <li><Link href="/terms" className="text-[13px] text-[#64748B] hover:text-[#2563EB]">Правила</Link></li>
              <li><Link href="/privacy" className="text-[13px] text-[#64748B] hover:text-[#2563EB]">Конфіденційність</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/support" className="text-[13px] text-[#64748B] hover:text-[#2563EB]">FAQ</Link></li>
              <li><Link href="/support" className="text-[13px] text-[#64748B] hover:text-[#2563EB]">Підтримка</Link></li>
              <li><Link href="/safety" className="text-[13px] text-[#64748B] hover:text-[#2563EB]">Спори</Link></li>
              <li><Link href="/safety" className="text-[13px] text-[#64748B] hover:text-[#2563EB]">Безпека</Link></li>
            </ul>
          </div>
        </div>
