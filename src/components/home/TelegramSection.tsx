        ...
        <div className="flex items-end justify-between mb-8">
          <div>
            ...
            <p className="text-[#475569] text-[14px]">
              {hasLots 
                ? 'Прозора історія ставок і прямі домовленості без платежів через KRAM.' 
...
export function HowItWorksSimple() {
  const steps = [
    ...
    },
    {
      ...
      desc: 'Робіть ставки для прозорого формування ціни та зберігайте домовленості у чаті KRAM.',
      ...
      <div className="max-w-[1320px] mx-auto px-4">
        ...
        <div className="text-center mb-12 max-w-2xl mx-auto">
          <div className="inline-flex items-center gap-1.5 h-6 px-3 bg-[#E8F5E9] border border-[#10B981]/10 rounded-full text-[10.5px] font-bold text-[#10B981] uppercase tracking-wide mb-3">
            ...
            <span>Прозорий процес домовленості</span>
          </div>
...
export function FAQSection() {
  const faqs = [
    ...
    },
    {
      ...
      a: 'KRAM працює як інформаційна платформа для ставок, лотів і фіксації домовленостей. Ми не є посередником, не приймаємо платежі та не зберігаємо гроші, тому не надаємо фінансових гарантій повернення.',
    },
    {
      q: 'Що робити з підозрілим лотом?',
      a: 'Якщо ви виявили порушення правил, шахрайство або вимагання передоплати, натисніть кнопку «Поскаржитись на лот» на сторінці товару. Модератори перевірять скаргу та можуть обмежити або заблокувати акаунт у разі підтвердження порушення.',
    },
  ]
