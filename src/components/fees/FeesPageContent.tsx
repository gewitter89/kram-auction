...
const faqs = [
  ...
  },
  {
    ...
    a: 'Оскільки KRAM не є фінансовим посередником, ми наполегливо радимо погоджувати відправку лотів Новою Поштою з післяплатою (накладеним платежем). Оглядайте товар у відділенні перед передачею грошей.',
  },
]
