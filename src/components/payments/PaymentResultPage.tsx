...
const content: Record<PaymentResultStatus, {
  ...
  failed: {
    ...
    description: 'Платіж міг бути скасований або відхилений. У режимі прямих домовленостей можна повернутися до угоди та обрати доступний спосіб підтвердження.',
    accent: 'text-[#EF4444]',
